  ...
  <main id="main" class="main">
    ...
    <section class="join_page">
      <form name="join_form" action="join_ok.php" method="post"
        onsubmit="return form_check();" class="user_join_part" id="join">
        <fieldset>
          <legend class="join_page_legend">회원정보</legend>
          <input type="hidden" name="pv_agree" value="y">
          <ul class="all_input_wrap">
            <li>
              <label for="u_id" >아이디 *</label>
              <input type="text" id="u_id" name="u_id" readonly value="">
              <button type="button" class="check_id" onclick="check_id()">중복검색</button>
              <span class="add_desc">(영문/숫자, 6~12자)</span>
              <span class="error_txt err_id"></span>
              <input type="hidden" class="dupid_check">
            </li>
            <li>
            ...
            <li class="user_birth">
              ...
              <input type="text" class="birth_year" id="birth" maxlength="8" oninput="autoHyphen_b(this)" name="birth">
              <input type="radio" id="solar_cal" name="birth_cal_type" value="1">
              <label for="solar_cal">양력</label>
              <input type="radio" id="lunar_cal" name="birth_cal_type" value="2">
            ...
            <li class="user_email">
              ...
              <input type="text" id="email_dns" name="email_dns" maxlength="10">
              <div class="email_sel">
            ...
            <li class="user_address">
              ...
              <input type="text" name="postalCode" id="postalCode" class="postalCode" readonly maxlength="5">
            ...
            <li class="user_phone">
              ...
              <input type="text" id="mobile" maxlength="13" oninput="autoHyphen_p(this)" name="mobile">
          ...
          <div class="btn_wrap">
            ...
            <button type="submit" form="join" class="user_join_btn">가입하기</button>
          </div>
        </fieldset>
      </form>
