...
<body>
  ...
  <main id="main" class="main">
    <div class="cont_title_wrap">
      <h2 class="cont_title">LOGIN</h2>
    </div>

    <section class="login_page">
      <form name="" action="login_ok.php" method="post" class="user_login_part on" onsubmit="return login_check()">
        <fieldset>
          <legend class="login_page_legend">로그인</legend>
          <p class="login_desc">본 사이트는 포트폴리오로 제작된 사이트임을 다시 한번 알립니다.</p>
          <p class="u_id_wrap">
            <label for="u_id" class="u_id_label">아이디</label>
            <i class="fas fa-user"></i>
            <input type="text" placeholder="아이디를 입력하세요." id="u_id" name="u_id">
            <span class="err_id"></span>
          </p>
          <p class="pwd_wrap">
            <label for="pwd" class="pwd_label">비밀번호</label>
          ...
          <div class="login_option">
            ...
            <label for="id_save" class="user_id_save"><span>아이디 저장</spa></label>
          ...
          <button type="submit" class="user_login_button">로그인</button>
          <button type="button" class="user_login_button kakao_btn">카카오로 시작하기</button>

        </fieldset>

        <div class="creat_account">
          <p>회원가입을 하시면, 더욱 편리한 서비스 이용이 가능합니다.</p>
          <a href="../members/join_step01.html" class="creat_account_btn">회원가입</a>
        </div>
